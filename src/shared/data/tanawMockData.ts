import type { AuditLog, Enterprise, EnterpriseAccount, FinalReport, IntakeReport, LguAccount, MapEnterprise, PipelineHealth, ReportEnterprise, SystemActivity, SystemAlert } from "../types";
...
export const systemActivities: SystemActivity[] = [
  {
    ...
    device: "CAM-07",
    summary: "Camera CAM-07 is currently offline and not transmitting data.",
    status: "Open",
    recommendedAction: "Notify the enterprise to inspect the camera connection.",
    timePeriod: "Today",
    deviceState: "Offline",
  ...
  },
  {
    ...
    summary: "Gateway sync is delayed. Records are waiting to upload.",
    status: "Pending",
    recommendedAction: "Monitor the sync queue and coordinate with the enterprise if the delay persists.",
    timePeriod: "Today",
    deviceState: "Delayed",
    requiresEnterpriseAttention: true,
  },
  {
    ...
    summary: "New LGU Staff account created for Ana Reyes.",
    status: "Completed",
    recommendedAction: "No follow-up is required unless the account assignment needs review.",
    timePeriod: "Today",
  },
  {
    id: "ACT-004",
    severity: "Info",
    type: "Enterprise Setup",
    time: "2h ago",
    initiatedBy: "Mike",
    enterprise: "Lolo Uweng Shrine",
    device: "GW-SHRINE-02",
    summary: "Enterprise gateway successfully linked.",
    status: "Completed",
    recommendedAction: "Confirm the enterprise camera list is ready for monitoring.",
    timePeriod: "Today",
    deviceState: "Healthy",
  },
  {
    ...
    enterprise: "San Pedro Apostol Parish Church",
    device: "GW-PARISH-04",
    summary: "Gateway GW-PARISH-04 is currently offline.",
    status: "Open",
    recommendedAction: "Ask the enterprise to inspect gateway power and network connectivity.",
    timePeriod: "Today",
    deviceState: "Offline",
    requiresEnterpriseAttention: true,
  },
  {
    ...
    enterprise: "San Pedro Apostol Parish Church",
    device: "CAM-07",
    summary: "Enterprise was notified of a camera connectivity issue.",
    status: "Acknowledged",
    recommendedAction: "Track the enterprise response and confirm the camera returns online.",
    timePeriod: "Today",
  },
  {
    id: "ACT-007",
    ...
    time: "5h ago",
    initiatedBy: "Mike",
    summary: "Enterprise incident notification rules were updated.",
    status: "Completed",
    recommendedAction: "No follow-up is required.",
    timePeriod: "Today",
  },
  {
    id: "ACT-008",
    ...
    enterprise: "Archie's Events Place",
    device: "CAM-03",
    summary: "Camera CAM-03 has unstable image quality and needs review.",
    status: "Acknowledged",
    recommendedAction: "Review the camera placement with the enterprise if image quality remains unstable.",
    timePeriod: "Earlier",
    deviceState: "Delayed",
    requiresEnterpriseAttention: true,
  },
  {
    ...
    summary: "IT account role updated for Kenneth Delicano.",
    status: "Completed",
    recommendedAction: "No action is required unless the access change needs approval review.",
    timePeriod: "Earlier",
  },
];
