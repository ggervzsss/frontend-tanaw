...
export function LoginForm({ onSubmit }: LoginFormProps) {
  return (
    <form autoComplete="off" onSubmit={onSubmit}>
      ...
      <motion.button
        type="submit"
        className="bg-tanaw-green w-full rounded-2xl p-5 text-xs font-bold tracking-[0.2em] text-white uppercase shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)] transition hover:-translate-y-px hover:bg-[#044a1e]"
        whileHover={{ y: -1 }}
        whileTap={{ scale: 0.99 }}
